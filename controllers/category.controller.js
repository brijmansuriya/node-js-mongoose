...
const register = async (req, res) => {
    try {
        ...
        const user_data = await UserModel.create({ username, phone, email, password: encPassword })
        // Create token
...
const login = async (req, res) => {
    try {
        ...
        const OldUser = await UserModel.findOne({ email: email });
        const encPassword = await bcrypt.hash('12345678', 12)
...
module.exports = { register, userlist, userDelete, login }